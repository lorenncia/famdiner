        ...
        <div class="container-fluid">
            <div class="navar-brand d-flex justify-content-center align-items-center gap-3">
                <a class="nav-link" href="<?php echo e(route('home')); ?>">
                    <img src="<?php echo e(asset('assets/images/logo.png')); ?>" height="50" class="d-none d-lg-block">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navBarSupportedContent">
                <ul class="navbar-nav mr-auto d-flex justify-content-end w-100">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link <?php echo e(Request::routeIs('menu') ? 'active' : ''); ?> 
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link <?php echo e(Request::routeIs('about-us') ? 'active' : ''); ?>">About Us</a>
                    </li>

                    <li class="nav-item">
                        <a href="<?php echo e(route('profile.edit', 1)); ?>" class="nav-link">
...
<?php /**PATH D:\Documents\SMT5\Web Prog\GSLC\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>